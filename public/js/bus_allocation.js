...
function injectStyles() {
  ...
  style.textContent = `
    ...
    @media print{@page{size:A4 landscape;margin:8mm}body{background:#fff}.sidebar,.topbar,.ba-head,.ba-controls,.ba-metrics,.ba-alerts,.ba-screen,.ba-screen-table{display:none!important}#contentArea{padding:0!important}.ba-layout{display:block}.ba-panel{border:0}.ba-panel-head{display:none}.ba-print-title{display:block;text-align:center;border:2px solid #000;margin-bottom:7px}.ba-print-title h1{margin:0;padding:7px;background:#000;color:#fff;font-size:20px}.ba-print-title h2{margin:5px;font-size:16px}.ba-print-only{display:table!important;width:100%;table-layout:fixed;border-collapse:collapse;font-size:12px}.ba-print-only th,.ba-print-only td{border:1px solid #000;padding:7px;vertical-align:middle;text-align:left}.ba-print-only th{font-size:11px;text-transform:uppercase}.ba-print-only td>small{display:block;margin-top:2px;font-size:9px}.ba-print-only .ba-print-bus{font-size:20px;font-weight:900}.ba-print-only .ba-section td{background:#000!important;color:#fff!important;padding:5px 7px!important;font-size:11px}.ba-print-only thead{display:table-header-group}.ba-print-only tr{break-inside:avoid}.ba-toast{display:none}}
  `;
