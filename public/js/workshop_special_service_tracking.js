...
function ensureFleetColumns() {
  ...
  PROGRAMS.forEach((program) => {
    ...
    th.dataset.columnKey = program.key === "fire" ? "fire-suppression" : "intercooler-radiator-wash";
    th.textContent = program.key === "fire" ? "FIRE SUPPRESSION" : "INTERCOOLER / RADIATOR WASH";
